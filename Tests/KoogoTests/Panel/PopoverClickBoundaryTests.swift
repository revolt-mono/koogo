...
final class PopoverClickBoundaryTests: XCTestCase {
    ...
    func testEachTriggerPressIsIndependentAndPreservesEventMetadata() throws {
        ...
        for type in [NSEvent.EventType.leftMouseDown, .leftMouseUp] {
            for count in [2, 3, 6] {
                ...
                let result = PopoverClickBoundary.Coordinator.independentClick(original, in: fixture.anchor)
    ...
    func testSingleClicksPassThroughUnchanged() throws {
        ...
        XCTAssertTrue(PopoverClickBoundary.Coordinator.independentClick(original, in: fixture.anchor) === original)
    }
